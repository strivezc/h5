<template>
  <div class="head-back">
    <img src="../../../../static/images/2021LearnReport/back.png" class="back-icon" @click="backAction" alt="">
    <span class="back-text">{{rightText}}</span>
    <span class="title">{{title}}</span>
    <span class="right-text" @click="rightAction">
      <img src="../../../../static/images/2021LearnReport/play.png" class="animation" alt="" @click="pauseAudio" v-if="isPlay">
      <img src="../../../../static/images/2021LearnReport/pause.png" alt="" @click="playAudio" v-else>
    </span>
